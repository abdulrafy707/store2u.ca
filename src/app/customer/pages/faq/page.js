        ...
        <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
          ...
          <div className="bg-white p-6 sm:p-8 md:p-10 lg:p-12 rounded-lg shadow-lg mt-8 md:mt-12">
            ...
            <section className="mb-6 md:mb-8">
              ...
              <p className="text-gray-600 leading-relaxed text-sm sm:text-base md:text-lg">
                If you need further assistance, please don't hesitate to reach out to us. You can contact our customer support team via email at <a href="mailto:info@store2u.ca" className="text-blue-500 hover:underline">info@store2u.ca</a> or by phone at <a href="tel:+923310356111" className="text-blue-500 hover:underline">+923310356111</a>. We're here to help!
              </p>
            </section>
          </div>
        </div>
