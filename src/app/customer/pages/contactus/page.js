        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                <strong>Email:</strong> <a href="mailto:info@store2u.com" className="text-blue-500 hover:underline">info@store2u.ca</a><br />
                <strong>Phone:</strong> <a href="tel:+923310356111" className="text-blue-500 hover:underline">+923310356111</a><br />
